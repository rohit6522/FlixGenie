...
function MovieCard({ movie, onClick }) {
  ...
  return (
    ...
    >
      <div className="relative aspect-[2/3] overflow-hidden rounded-lg group ring-2 ring-transparent hover:ring-red-600 transition-all">
        <img
          src={movie.Poster}
          alt={movie.Title}
        ...
        />
        {!imgLoaded && <div className="absolute inset-0 shimmer"></div>}
